...
cuentas = {
    ...
    "Deudores x ventas": {"tipo": "HABER", "claves": ["ACREDITAMIENTO PRISMA-COMERCIOS", "DEPOSITO EN EFECTIVO", "SERVICIO PAGO A PROVEEDORES", "TRANSFERENCIA PEI PAGO CON TRANSF.", "TRANSFERENCIAS CASH PROVEEDORES","NAVE PAGO CON TRANSFERENCIA", "NAVE - VENTA CON TARJETA"]},
