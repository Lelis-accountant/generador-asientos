...
cuentas = {
    ...
    "Proveedores": {"tipo": "DEBE", "claves": ["PERCEP. IVA", "IMP. ING. BRUTOS", "TRF INMED PROVEED", "PAGO DE SERVICIOS", "PAGO CON TRANSFERENCIA", "DEB. AUTOM. DE SERV."]},
    ...
    "Deudores x ventas": {"tipo": "HABER", "claves": ["ACREDITAMIENTO PRISMA-COMERCIOS", "DEPOSITO EN EFECTIVO", "SERVICIO PAGO A PROVEEDORES", "TRANSFERENCIA PEI", "TRANSFERENCIAS CASH PROVEEDORES","NAVE PAGO CON TRANSFERENCIA", "NAVE - VENTA CON TARJETA"]},
